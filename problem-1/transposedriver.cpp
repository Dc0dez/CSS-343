...
// File is used to test the functionality of all the methods in transposelist.cpp

// -------------------------------------------------------------------------------------------------------------------- 

// Tests will correctly produce expected outputs if the methods in transposelist.cpp are structured correctly
...
// Tests will ensure that nodes containing specific values are correctly swapped with the previous node
// Tests will clear all the nodes from the lists at the end and ensure double clearing does not break the program
...
int main() {
    ...
    TransposeList copiedList = testList;
