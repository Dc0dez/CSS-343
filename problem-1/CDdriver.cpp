...
// File is used to test the functionality of all the methods in CDLinkedList.cpp
...
// reset all traverse count first
  ...
  CDLinkedList copiedList = testList;
  ...
  cout << endl;
  cout<< "copiedList.contains(3)="<<copiedList.contains(3)<<endl;

  // tests 'contains' method for copied list
  cout << "# members in copied list after access 3: size= " << copiedList.getCurrentSize() << ", traverseCount=" << copiedList.getTraverseCount() << endl;
  for (int i = 0; i < copiedList.getCurrentSize(); i++)
    cout << copiedList.retrieve(i) << endl;
